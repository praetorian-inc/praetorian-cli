...
The CLI uses API key authentication for secure, token-based access.

### Generate an API Key

1. **Generate an API Key in the Guard UI:**
   - Click the Praetorian icon in the top right corner
...
- **API Key Secret**: The secret value for your API key
