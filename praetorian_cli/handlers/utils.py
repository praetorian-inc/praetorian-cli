...
class Risk(Enum):
    ...
    CLOSED_HIGH = "CH"
    CLOSED_CRITICAL = "CC"
    CLOSED_INFO_FALSE_POSITIVE = "CIF"
    CLOSED_LOW_FALSE_POSITIVE = "CLF"
    CLOSED_MEDIUM_FALSE_POSITIVE = "CMF"
    CLOSED_HIGH_FALSE_POSITIVE = "CHF"
    CLOSED_CRITICAL_FALSE_POSITIVE = "CCF"
    ...
    CLOSED_INFO_SCOPE = "CIS"
    CLOSED_LOW_SCOPE = "CLS"
    CLOSED_MEDIUM_SCOPE = "CMS"
    CLOSED_HIGH_SCOPE = "CHS"
    CLOSED_CRITICAL_SCOPE = "CCS"
    CLOSED_MACHINE = "M"
