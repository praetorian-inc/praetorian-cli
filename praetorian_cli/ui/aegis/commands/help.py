...
def handle_help(menu, args):
    ...
    commands_table.add_row("job capabilities [--details]", "List available v1 capabilities")
    commands_table.add_row("job run <capability>", "Run capability on selected v1 agent")
    ...
    examples_table.add_row("job capabilities", "List available v1 capabilities")
    examples_table.add_row("job caps --details", "Show full v1 capability descriptions")
    examples_table.add_row("job run windows-enum", "Run v1 capability on selected agent")
