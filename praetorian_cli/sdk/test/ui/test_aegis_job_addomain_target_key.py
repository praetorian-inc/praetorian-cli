...
def test_job_run_addomain_uses_asset_key_from_database(monkeypatch):
    ...
    # Mock user interactions: confirm suggested capability, decline credentials, confirm running the job
    confirm_index = [0]
    confirm_responses = [True, False, True]  # Confirm suggested capability, Decline credentials, Confirm running the job
